...
data class UserAgentInterceptor(
    ...
    private var FORMAT_AS_JSON: Boolean = true,
    private var skipLog: Boolean = false,
    private var easyLog: Boolean = false,
    ...
    override fun intercept(chain: Interceptor.Chain): okhttp3.Response {
        ...
        if(headers != null) this.headers.forEach{ builder.header(it.key, it.value) }
