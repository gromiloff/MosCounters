...
public class FloatingActionMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        //TODO: поставить проверку, если иконка не изменена в приложении - то анимация должна быть вращение
        mIcon = ContextCompat.getDrawable(context, attr.getResourceId(R.styleable.FloatingActionMenu_menu_icon, R.drawable.fab_add));
    ...
    private void createMenuButton() {
        ...
        //  states.addState(new int[]{android.R.attr.state_selected}, getResources().getDrawable(R.drawable.fab_add));
        states.addState(new int[]{}, mIcon);
        mImageToggle.setImageDrawable(states);
    ...
    public void open(final boolean animate) {
        if (!isOpened()) {
            ...
            mImageToggle.animate().setListener(new AnimatorListenerAdapter() {
                @Override
                public void onAnimationEnd(Animator animation) {
                    mImageToggle.animate().setListener(new AnimatorListenerAdapter() {
                        @Override
                        public void onAnimationStart(Animator animation) {
                            mImageToggle.setSelected(true);
                        }
                    })
                            .alpha(1.0f)
            ...
            mImageToggle.animate().setListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    mImageToggle.animate().setListener(new AnimatorListenerAdapter() {
                        @Override
                        public void onAnimationStart(Animator animation) {
                            mImageToggle.setSelected(false);
                        }
                    })
                            .alpha(1.0f)
                            .setDuration(ANIMATION_DURATION / 2)
